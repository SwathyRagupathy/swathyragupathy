...
I write blogs and articles on Medium

Find me on LinkedIn and follow along :)
...
Currently working as an AI Engineer at Community Dreams Foundation (June 2025 - Present), where I built an Agentic RAG pipeline that increased engagement from 11% to 26%, reduced manual outreach time by 87%, and improved reply-to-meeting conversion by 2.4x through prompt engineering and automated A/B testing.​

Interned at SBNA Software Solutions (Aug 2022 - July 2023), contributing to a production recommendation engine serving 100K+ users with collaborative filtering that supported $420K incremental revenue, deployed a churn prediction model (84% precision), and optimized e-commerce search latency by 62%.​

Built multiple end-to-end AI projects including Github2Blog (LangGraph multi-agent workflow reducing blog creation from 4-6 hours to 5 minutes), Resume Optimizer (BERT embeddings achieving 89% match accuracy), Voice-Enabled RAG Assistant (78% answer accuracy with FastAPI), Multimodal Conversational AI (LLaVA fine-tuned on 377K X-rays, 75% VQA accuracy), and Real-Time Demand Forecasting (XGBoost+LSTM reducing MAPE by 35%).​
